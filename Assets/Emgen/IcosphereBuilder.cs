    ...
    public class CuboidBuilder
    {
        ...
        class MidpointTable
        {
            ...
            public int GetMidpoint(int i1, int i2)
            {
                ...
                var i = vertexCache.AddVertex(mid);
                table[key] = i;
                return i;
            }
        }
        ...
        public CuboidBuilder()
        {
			...
			vertexCache.AddVertex(new Vector3(-0.5f, -0.5f, -0.5f));
			vertexCache.AddVertex(new Vector3(-0.5f, 0.5f, -0.5f));
			vertexCache.AddVertex(new Vector3(0.5f, 0.5f, -0.5f));
			vertexCache.AddVertex(new Vector3(0.5f, -0.5f, -0.5f));
			...
			vertexCache.AddTriangle(0,1,2);
			vertexCache.AddTriangle(0,2,3);
			vertexCache.AddTriangle(3,2,5);
			vertexCache.AddTriangle(3,5,4);

			vertexCache.AddTriangle(5,2,1);
			vertexCache.AddTriangle(5,1,6);
			vertexCache.AddTriangle(3,4,7);
			vertexCache.AddTriangle(3, 7, 0);

			vertexCache.AddTriangle(0, 7, 6);
			vertexCache.AddTriangle(0, 6, 1);
			vertexCache.AddTriangle(4, 5, 6);
			vertexCache.AddTriangle(4, 6, 7);
