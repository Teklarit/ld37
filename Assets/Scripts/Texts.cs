...
public static class Texts {
	public static Dictionary<string, string> texts = new Dictionary<string, string>	{
		...
		{ "rifle", "Aaaahhh, I remember now. The best gift I've ever received, a custom made replica of a german rifle, specially fashioned for hunting, which quickly became my favourite hobby. I REMEMBER THE COMBINATION NOW." },
